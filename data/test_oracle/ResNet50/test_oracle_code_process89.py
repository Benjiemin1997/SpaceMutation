    ...
    test_cases = [
        {
            ...
            'expected_output': torch.randn(1, 1000)  # Assuming the expected output has the same shape for simplicity
        },
        {
            'name': 'case_2',
            'input': torch.randn(1, 3, 224, 224),
            'expected_output': torch.randn(1, 1000)
        }
    ]

    # Expected outputs for the test cases
    expected_outputs = {
        'case_1': torch.randn(1, 1000),
        'case_2': torch.randn(1, 1000)
    }
