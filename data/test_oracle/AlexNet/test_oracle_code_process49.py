...
class TestReplaceActivations(unittest.TestCase):
    ...
    def test_replace_activations(self):
        ...
        self.assertNotEqual(mock_model[0].__class__, mutated_model[0].__class__)
        self.assertNotEqual(mock_model[1].__class__, mutated_model[1].__class__)
        self.assertNotEqual(mock_model[2].__class__, mutated_model[2].__class__)
        self.assertNotEqual(mock_model[3].__class__, mutated_model[3].__class__)
        self.assertNotEqual(mock_model[4].__class__, mutated_model[4].__class__)
        self.assertNotEqual(mock_model[5].__class__, mutated_model[5].__class__)
        self.assertNotEqual(mock_model[6].__class__, mutated_model[6].__class__)
        self.assertNotEqual(mock_model[7].__class__, mutated_model[7].__class__)
