...
class TestModelMutations:
    ...
    def test_remove_activations(self):
        ...
        # Check if the mutated model has changed
        assert not torch.equal(model.linear1.weight, mutated_model.linear1.weight)
    ...
    def test_replace_activations(self):
        ...
        mutated_model = replace_activations(model, nn.ReLU, nn.Tanh)
    ...
    def test_uniform_fuzz_weight(self):
        ...
        # Apply Uniform Fuzz to the model's weight
