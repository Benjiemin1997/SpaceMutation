...
class TestModelMutations:
    ...
    def test_gaussian_fuzzing_splayer(self):
        ...
        assert any([isinstance(module, nn.ReLU) or isinstance(module, nn.LeakyReLU) for name, module in no_activ_model.named_modules()]), "Some activations should be removed."
